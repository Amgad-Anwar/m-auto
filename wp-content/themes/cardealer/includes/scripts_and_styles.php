...
if ( ! function_exists( 'cardealer_load_style_script' ) ) {
	...
	function cardealer_load_style_script() {
		...
		wp_register_script( 'imagesloaded', CARDEALER_URL . '/js/imagesloaded/imagesloaded.pkgd.js', array(), '4.1.4', true );
		...
		wp_register_script( 'cardealer-js', CARDEALER_URL . '/js/custom.js', array( 'jquery', 'imagesloaded' ), CARDEALER_VERSION, true );
