	...
	function cardealer_tgmpa_plugin_list() {
		...
		$required_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-helper-library-3.6.0.zip' ),
				'required'           => true,
			...
			array(
				...
				'slug'               => 'revslider',
				'source'             => cardealer_tgmpa_plugin_path( 'revslider-6.5.11.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
			...
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'advanced-custom-fields-pro-5.11.3.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
		...
		$recommended_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-front-submission-1.8.2.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'details_url'        => '',
