...
$lead_form = cardealer_get_lead_form( 'email_to_friend' );
?>
<li>
	<a data-toggle="modal" data-target="#email_to_friend" href="javascrip:void(0)"><i class="<?php echo esc_attr( $lead_form['icon'] ); ?>"></i><?php echo esc_html( $lead_form['btn_label'] ); ?></a>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h6 class="modal-title" id="email_to_friend_lbl"><?php echo esc_html( $lead_form['modal_title'] ); ?></h6>
				</div>
