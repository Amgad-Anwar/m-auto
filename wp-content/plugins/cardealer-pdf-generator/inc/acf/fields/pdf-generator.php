					...
					array(
						...
						'sub_fields'        => array(
							...
							array(
								...
								'type'              => 'range',
								'instructions'      => esc_html__( 'If Margin Top Is Not Set Then Default Value Set', 'cardealer-pdf-generator' ),
								'required'          => 0,
							...
							array(
								...
								'type'              => 'range',
								'instructions'      => esc_html__( 'If Margin Bottom Is Not Set Then Default Value Set', 'cardealer-pdf-generator' ),
								'required'          => 0,
								'conditional_logic' => array(
									array(
										array(
							...
							array(
								...
								'type'              => 'range',
								'instructions'      => esc_html__( 'If Margin Left Is Not Set Then Default Value Set', 'cardealer-pdf-generator' ),
								'required'          => 0,
								'conditional_logic' => array(
									array(
										array(
							...
							array(
								...
								'type'              => 'range',
								'instructions'      => esc_html__( 'If Margin Right Is Not Set Then Default Value Set', 'cardealer-pdf-generator' ),
								'required'          => 0,
								'conditional_logic' => array(
									array(
										array(
