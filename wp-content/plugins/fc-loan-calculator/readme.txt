...
Donate link:
Tags: calculator, loan, loan calculator, amortization, amortization schedule, payment calculator, plugin, sidebar, widget
...
1. The Loan Calculator's front end showing 2 of the 4 configurable sizes at about 70% actual size. Resize buttons are optional.
...
* Renamed file js/interface.LOAN-WIDGET.min.js to js/interface.LOAN-WIDGET.js (the file is still minified)
= 1.4.4 =
