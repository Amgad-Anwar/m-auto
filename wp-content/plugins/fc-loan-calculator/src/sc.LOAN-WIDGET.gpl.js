...
FC$ = (function (EQ, $) {
	...
	var strHTMLTitle = '<title>' + FC.strs.s201 + '</title>';
	...
	//
	var createLoanScheduleTableMIT = function (schedule) {
		var L, i, strReportPage, strSchedule, rate, pmt, interest, prin, bal, num, freq, strDate, strDateFirst, strDateLast, periodYear, totalInterest, totalPI, transaction, roundingMsg, strAmortMthd, strUnadjustedBal;
		...
		if (schedule.length > 0) {
			...
			if (EQ.summary.unadjustedBalance < 0.0) {
				...
				roundingMsg = FC.strs.s202 + ' ' + strUnadjustedBal + ' ' + FC.strs.s203;
			} else if (EQ.summary.unadjustedBalance > 0.0) {
				// roundingMsg = 'Last payment amount increased by ' + strUnadjustedBal + ' due to rounding';
				roundingMsg = FC.strs.s204 + ' ' + strUnadjustedBal + ' ' + FC.strs.s203;
			} else {
				roundingMsg = '';
			}

			// strAmortMthd = 'Calculation method:&nbsp;Normal';
			strAmortMthd = FC.strs.s225;

			strSchedule.append('<table>');
			strSchedule.append('<thead>');
			// strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">Loan Summary</td></tr>');
			strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">' + FC.strs.s205 + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + FC.strs.s208 + ':</td><td class="right">' + bal + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + FC.strs.s209 + ':</td><td class="right">' + num + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + FC.strs.s210 + ':</td><td class="right">' + rate + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + FC.strs.s211 + ':</td><td class="right">' + pmt + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + FC.strs.s212 + ':</td><td class="right">' + strDate + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + FC.strs.s213 + ':</td><td class="right">' + strDateFirst + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + FC.strs.s214 + ':</td><td class="right">' + freq + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + FC.strs.s215 + ':</td><td class="right">' + strDateLast + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + FC.strs.s216 + ':</td><td class="right">' + totalInterest + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + FC.strs.s217 + ':</td><td class="right">' + totalPI + '</td></tr>');
			...
			strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">' + FC.strs.s218 + '</td></tr>');
			strSchedule.append('<tr class="empty"><td colspan="6"></td></tr>');
			...
			strSchedule.append('<tr class="label cHead"><td class="rpt6colvnarrow">#/' + FC.strs.s219 + '</td><td class="rpt6colnarrow center">' + FC.strs.s220 + '</td><td class="rpt6col right">' + FC.strs.s221 + '</td><td class="rpt6col right">' + FC.strs.s222 + '</td><td class="rpt6col right">' + FC.strs.s223 + '</td><td class="rpt6colwide right">' + FC.strs.s224 + '</td></tr>');

			strSchedule.append('</thead>');

			strSchedule.append('<tfoot>');
			strSchedule.append('<tr class="label rpt_footer left"><td colspan="2">' + roundingMsg + '</td><td colspan="2"></td><td colspan="2" class="right" style="vertical-align: text-top">' + strAmortMthd + '</td></tr>');
			strSchedule.append('<tr class="label rpt_footer center"><td colspan="6">financial-calculators.com</td></tr>');
			strSchedule.append('</tfoot>');
					...
					tooltips: {
						...
						callbacks: {
							label: function (tooltipItems, data) {
								...
								label[1] = FC.strs.s228 + ': ' + EQ.formatLocalFloat(EQ.roundMoney((tooltipData / createChartsMIT.payments) * 100, 1), EQ.rateConventions, 1);
								return label;
							}
						}
					},
	...
	FC.showLoanSchedule = function (schedule) {
		createLoanScheduleTableMIT(schedule);
	}; // showLoanSchedule


	FC.showLoanCharts = function (schedule) {
