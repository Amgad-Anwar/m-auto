...
var SC$ = (function (EQ, $) {
	...
	var createLoanScheduleTableMIT = function (schedule) {
		var L, i, strReportPage, strSchedule, rate, pmt, interest, prin, bal, num, freq, strDate, strDateFirst, strDateLast, periodYear, totalInterest, totalPI, transaction, pnts, pntsInMoney, roundingMsg, strAmortMthd, strUnadjustedBal, whichSchedule;
		...
		if (schedule.length > 0) {
			...
			// TODO: points?
			//pnts = EQ.formatLocalFloat(results.pointsPct * 100, EQ.rateConventions, 4);
			pnts = 0.0;

			//pntsInMoney = EQ.formatLocalFloat(results.pointsMoney, EQ.moneyConventions, 2);
			pntsInMoney = 0.0;
	...
	SC.showLoanSchedule = function (schedule) {
