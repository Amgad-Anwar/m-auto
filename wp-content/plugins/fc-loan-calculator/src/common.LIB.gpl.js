/**
 * -----------------------------------------------------------------------------
 * (c) 2016-2022 Pine Grove Software, LLC -- All rights reserved.
...
FC$ = (function (STRS) {
	...
	FC.ERR_MSGS = {
		...
		noDelKey: FC.strs.s001,
		noCurKeys: FC.strs.s002 + '\n\n' + FC.strs.s003 + '\n\n' + FC.strs.s004 + '\n\n' + FC.strs.s005 + '\n\n' + FC.strs.s006 + '\n\n' + FC.strs.s007,
	...
	var esInvalidDateMath = FC.strs.s011 + '\n\n' + FC.strs.s012;
	// var esInvalidYear = 'Date is not valid - bad year.';
	var esInvalidYear = FC.strs.s013;
	...
	FC.MONTHS = [FC.strs.s014, FC.strs.s015, FC.strs.s016, FC.strs.s017, FC.strs.s018, FC.strs.s019, FC.strs.s020, FC.strs.s021, FC.strs.s022, FC.strs.s023, FC.strs.s024, FC.strs.s025];
	...
	NE.prototype.getUSNumber = function () {
		...
		// 02/23/2022 - fix.
		// If element's value is already a number, as when being initilized from shortcode, do not try to convert it
		if (isNaN(n)) {
			n = FC.getUSNumStr(n, this.sep, this.dPnt, this.ccy, this.ccy_r);
		}
	...
	Vector.prototype.getElementAt = function (i) {
		try {
			...
			return FC.strs.s027 + ' ' + e + ' ' + FC.strs.s028 + ' ' + i;
		}
	};
